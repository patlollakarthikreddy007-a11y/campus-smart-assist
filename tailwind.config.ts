    ...
    extend: {
      colors: {
        ...
        campus: {
          ...
          cyan: "hsl(var(--campus-cyan))",
        },
        category: {
          schedules: "hsl(var(--schedules-color))",
          faculty: "hsl(var(--faculty-color))",
          dining: "hsl(var(--dining-color))",
          library: "hsl(var(--library-color))",
          admin: "hsl(var(--admin-color))",
          general: "hsl(var(--general-color))",
        },
        secondary: {
